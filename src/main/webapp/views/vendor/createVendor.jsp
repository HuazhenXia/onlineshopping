...
<body>
	...
	<div class="container">
		<form:form modelAttribute="vendor" action="/vendorRegister" method="post">
			<table>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
					<td><form:input path="accountNumber" placeholder="Account Number" /></td>
				...
				<tr>
					...
					<td><form:password path="user.password" placeholder="Password" /></td>
