		...
		<div class="view-product">
			<div class="info-center">
				<div class="manage-head">
					<h4 class="padding-left manage-head-con">My Profile</h4>
				</div>
				<div class="container" style="margin-top:20px;">
					<form:form modelAttribute="vendorForm" action="/vendor/profile" method="post">
						<div class="form-group">
							<table class="table">
								...
								<tr>
									<td><form:label path="address.zip">Zip Code:</form:label></td>
								...
								<tr>
									<td colspan="2"><input type="submit" value="Save" style="background-color:#2a94de; color:#fff;" class="btn btn-default"/></td>
								</tr>
							</table>
						</div>
					</form:form>
